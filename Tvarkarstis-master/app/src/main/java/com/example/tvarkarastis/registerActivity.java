...
public class registerActivity extends AppCompatActivity {
    ...
    EditText emailID, CreatePassword;
    Button registruotis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView registruotistext = findViewById(R.id.Prisijungimas);

        if(preferences.kalba==0){
            emailID.setHint("Email");
            CreatePassword.setHint("Slaptažodis");
            registruotis.setText("Registruotis");
            registruotistext.setText("Registracija");
        }
        if(preferences.kalba==1){
            emailID.setHint("Email");
            CreatePassword.setHint("Password");
            registruotis.setText("Register");
            registruotistext.setText("Sign up");
        }
